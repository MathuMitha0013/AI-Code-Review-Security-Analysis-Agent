...
RULE_SEVERITY = {
    ...
    "CROSS_SITE_SCRIPTING_XSS": Severity.HIGH,
    "CSRF_PROTECTION_DISABLED": Severity.HIGH,
    "BROKEN_ACCESS_CONTROL_MISSING_AUTH": Severity.HIGH,
    "INSECURE_COOKIE_ATTRIBUTES": Severity.MEDIUM,

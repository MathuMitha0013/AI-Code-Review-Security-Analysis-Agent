          ...
          <div className="flex items-center space-x-3">
            <div className="relative flex items-center justify-center">
              <img
                src={logoDark}
                alt="Secoria Logo"
                className="h-8 w-8 object-contain drop-shadow-[0_2px_10px_rgba(124,58,237,0.45)] transition-transform hover:scale-105"
              />
              <span className="absolute -top-0.5 -right-0.5 flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500 border border-[var(--color-surface)]"></span>
              </span>
            </div>
            <div>
              <h3 className="font-bold text-[var(--color-text-primary)] text-sm leading-tight">Secoria Assistant</h3>
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-3">
              <div className="relative group flex items-center justify-center mb-1">
                ...
                <img
                  src={logoDark}
                  alt="Secoria Logo"
                  className="relative h-14 w-14 object-contain drop-shadow-[0_4px_16px_rgba(124,58,237,0.45)] transition-transform group-hover:scale-110"
                />
              </div>

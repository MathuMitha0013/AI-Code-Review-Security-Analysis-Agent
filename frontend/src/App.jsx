        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-bold rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-600 dark:text-purple-400 hover:bg-purple-500/20 hover:border-purple-500/50 shadow-xs transition-all cursor-pointer group"
              title="Inspect Pull Requests & Git Diffs • Supports Python (.py) & Java (.java)"
            >
